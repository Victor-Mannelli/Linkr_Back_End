...
export async function getUserPosts(user_id,limit,offset) {
	return connection.query(
		"SELECT u.id, u.username, u.profile_picture, p.* FROM users AS u LEFT JOIN posts as p ON u.id = p.user_id WHERE u.id = $1 LIMIT $2 OFFSET $3",
